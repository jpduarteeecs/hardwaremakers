...
void setup() {
  ...
  Serial.println("\nYou're wwwwwwwwww connected to the network");
  Serial.println("Waiting fffffffffor an ip address");
  
  IPAddress localIP = WiFi.localIP();
  while (localIP[0] == 0) {
    localIP = WiFi.localIP();
    Serial.println("waiting ssssssssfor an IP address");
    delay(1000);
  }
  
  
  Serial.println("\nIP Addresssssssssssss obtained");
